...
## DB Assignments  [![Build Status](https://travis-ci.org/Qry1/db-assignments.svg?branch=master)](https://travis-ci.org/Qry1/db-assignments)
...
* Run `git clone https://github.com/Qry1/db-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/Qry1/db-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
